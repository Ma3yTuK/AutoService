...
urlpatterns = [
    ...
    path("types", views.AdminTypesView.as_view(template_name="adm/types.html"), name="types"),
    path("type_create", views.AdminTypeCreateView.as_view(template_name="adm/type_create.html"), name="type_create"),
    path("type_update/<int:id>", views.AdminTypeUpdateView.as_view(template_name="adm/type_update.html"), name="type_update"),
    path("type_delete/<int:id>", views.AdminTypeDeleteView.as_view(), name="type_delete"),
